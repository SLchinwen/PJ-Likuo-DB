---
doc_id: core_governance_lifecycle_overview
layer: core
domain: governance
stability: high
visibility: internal
...
| **程式編碼原則** | 模組代號、主程式／子編碼、權限表、命名（TABLE/API/雛型） | 本 Template Repo：core/；專案 Repo：internal_docs/ | 公司標準 | 全階段引用；見 [程式編碼原則｜共用規範](程式編碼原則_共用規範.md)、[模組與程式代碼編碼原則](模組與程式代碼編碼原則.md) |
...
| 用途 | 文件／範本 | 說明 |
| :--- | :--- | :--- |
| **公司背景／客戶** | 本 Template Repo：`templates/tpl_客戶與專案背景.md`；專案 Repo：00_Templates/（若已建立） | 客戶資料卡、產業背景；補足 Discovery 輸入 |
| **訪談** | 本 Template Repo：`templates/tpl_discovery_note.md`；專案 Repo：00_Templates/ | 訪談紀錄 |
| **RFP** | 本 Template Repo：`templates/tpl_rfp_系統全貌.md`；專案 Repo：00_Templates/ | 系統全貌、階段、主程式清單 |
...
| **雛型** | 本 Template Repo：`templates/tpl_prototype_html.html`；[雛型產出規範與指引](雛型產出規範與指引.md) | 專案 Repo：定稿後置 02_雛型/prototype/ 或 docs/prototype/ |
| **交付包產出** | [AI_產出交付文件指引](AI_產出交付文件指引.md)、[交付包結構範本](../standards/交付包結構範本.md) | Step 1～7＋4.6；範本見本 Template Repo templates/、專案 Repo 00_Templates/Tpl_交付開發包_* |
| **工程師接手** | [開發團隊_AI開發指引](開發團隊_AI開發指引.md)、交付包內 `03_附錄/工程師開工指引.md` | 必讀、自檢、命名對齊 |
| **驗收** | [驗收條件範本](../standards/prd/驗收條件範本.md)、本 Template Repo：`templates/tpl_驗收條件.md` | 結構化 ID、類型 F/P/S/D/B |
| **需求變更** | 本 Template Repo：`templates/tpl_需求變更單.md`；專案 Repo：00_Templates/ | 變更補充包輸入 |

---

## 4. 治理總則與本總覽之關係

- **[GOV_e化專案治理總則](gov_e化專案治理總則.md)**：母體文件；專案 Repo 目錄建議：01_Discovery、02_Analysis、03_Solution、99_Archives、docs、internal_docs；本 Template Repo 為 core/standards/templates/ops/index/_archive；YAML、命名、歸檔。
- **本總覽**：從「需求→RFP→PRD→程式編碼→雛型→交付包→釋出」之**流程與手off**；不取代 GOV，與 GOV 互補。
- **專案 Repo 之 internal_docs**：公司標準、協作、程式編碼、交付包、AI 產出之**單一真相來源**；_Inbox 待歸檔後以 internal_docs 為準。本 Template Repo 治理入口為 core/ 與 index/00_overview.md。

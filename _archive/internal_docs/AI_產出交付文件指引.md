...
| **範本路徑** | `00_Templates/` 下之交付用範本、`internal_docs/standards/` 下之中央標準 |
...
- 範本：`00_Templates/Tpl_交付開發包_README.md`
- 填寫：專案名稱、本階段範圍、交付版次、對應 Tag／commit、**依賴清單**（§3）、**技術棧／認證**（§4）、目錄結構、使用指引

### Step 3：產出 .cursorrules

- 範本：`internal_docs/standards/cursorrules_範本.md`
...
範本：`00_Templates/Tpl_工程師開工指引.md`（含**交付包接收者自檢**清單）
...
1. 使用範本：`00_Templates/Tpl_需求變更單.md`
...
1. 使用範本：`00_Templates/Tpl_批次規格.md`
...
1. 使用範本：`00_Templates/Tpl_驗收條件.md` 或併入 `Tpl_情境與驗收說明_交付用.md`
...
| 用途 | 路徑 |
| :--- | :--- |
| 交付包結構 | internal_docs/standards/交付包結構範本.md |
| 子程式清單治理規範 | internal_docs/standards/子程式清單與實作建議_治理規範.md |
| 子程式實作建議 | internal_docs/standards/子程式實作建議_標準.md |
| **交付包 README** | 00_Templates/Tpl_交付開發包_README.md |
| **PRD 本階段範圍摘要** | 00_Templates/Tpl_PRD_本階段範圍摘要.md |
| **情境與驗收說明** | 00_Templates/Tpl_情境與驗收說明_交付用.md |
| **子程式清單** | 00_Templates/Tpl_子程式清單_交付用.md |
| **工程師開工指引** | 00_Templates/Tpl_工程師開工指引.md |
| **欄位名稱對照表** | 00_Templates/Tpl_欄位名稱對照表_交付用.md |
| **程式代號與權限矩陣** | 00_Templates/Tpl_程式代號與權限矩陣_交付用.md |
| **開發要求與資安清單** | 00_Templates/Tpl_開發要求與資安清單.md |
| 工程師開工指引治理規範 | internal_docs/standards/工程師開工指引_治理規範.md |
| Azure 環境建議 | internal_docs/Azure環境建議.md |
| 驗收條件格式 | internal_docs/standards/驗收條件範本.md |
| 批次規格格式 | internal_docs/standards/批次規格範本.md |
| 資安要求 | internal_docs/standards/資安要求清單.md |
| cursorrules | internal_docs/standards/cursorrules_範本.md |
| 需求變更單 | 00_Templates/Tpl_需求變更單.md（若存在） |
| 批次規格 | 00_Templates/Tpl_批次規格.md（若存在） |
